...
#default parameters
workdir = Path.cwd() #change to folder where you want to have database.
...
zipName = 'nvdcve-1.1-modified.json.zip'
jsonFileName = 'nvdcve-1.1-modified.json'
os.chdir('Download')
download_source_file_json(zipName)
unzip_file(zipName)

# Compare modified file do database
os.chdir(workdir)
jsonPathName = Path('Download/' + jsonFileName)
